...
export class Paso8BienesMueblesComponent {
  ...
  onSubmit(): void {
    // const ok = (this.otrosBienesData.length > 0 && this.tieneVehiculos) || (this.aeronavesData.length > 0 && this.tieneAeronaves) || (this.navesData.length > 0 && this.tieneNaves) || (this.otrosBienesData.length > 0 && this.tieneOtrosBienes) || (!this.tieneVehiculos && !this.tieneAeronaves && !this.tieneNaves && !this.tieneOtrosBienes);
    const ok = true;
    const key = 'paso8';
