...
@Component({
  selector: 'app-jefe-servicio-archivadas',
  standalone: false,
  templateUrl: './jefe-servicio-archivadas.component.html',
  styleUrls: ['./jefe-servicio-archivadas.component.scss']
})
export class JefeServicioArchivadasComponent {
