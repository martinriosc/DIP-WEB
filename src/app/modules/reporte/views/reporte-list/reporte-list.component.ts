...
export class ReporteListComponent implements AfterViewInit, OnInit {
  showFilters = false;
  isLoading = false;
  ...
  dataSource = new MatTableDataSource<ReporteItem>([]);
  totalItems: number = 0;
  pageSize: number = 10;
      ...
      const mockData: ReporteItem[] = [
        {
          ...
          tipo: 'Tipo A',
          estado: 'Activo',
          descripcion: 'Descripción del reporte 001',
        ...
        },
        {
          ...
          tipo: 'Tipo B',
          estado: 'Pendiente',
          descripcion: 'Descripción del reporte 002',
  ...
  crear() {
    this._toastr.info('Funcionalidad en desarrollo', 'Crear Reporte');
  }
