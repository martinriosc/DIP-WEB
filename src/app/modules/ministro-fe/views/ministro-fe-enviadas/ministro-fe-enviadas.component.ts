...
@Component({
  selector: 'app-ministro-fe-enviadas',
  standalone: false,
  templateUrl: './ministro-fe-enviadas.component.html',
  styleUrls: ['./ministro-fe-enviadas.component.scss']
})
export class MinistroFeEnviadasComponent {
