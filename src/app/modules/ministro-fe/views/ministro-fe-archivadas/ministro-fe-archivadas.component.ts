...
@Component({
  selector: 'app-ministro-fe-archivadas',
  standalone: false,
  templateUrl: './ministro-fe-archivadas.component.html',
  styleUrls: ['./ministro-fe-archivadas.component.scss']
})
export class MinistroFeArchivadasComponent {
